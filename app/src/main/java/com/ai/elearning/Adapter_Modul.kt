...
class Adapter_Modul (private val context: Context, private val databaseRef: DatabaseReference, private val loading: LottieAnimationView) :
    RecyclerView.Adapter<Adapter_Modul.Home>() {
    ...
    class Home(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val container_modul: ConstraintLayout = itemView.findViewById(R.id.container_item_id)
        val tv_judul_modul: TextView = itemView.findViewById(R.id.tv_judul_id)
        val tv_deskripsi_modul: TextView = itemView.findViewById(R.id.tv_deskripsi_id)
    ...
    override fun onBindViewHolder(holder: Home, position: Int) {
        ...
        holder.tv_judul_modul.text = currentItem.judul_modul
        holder.tv_deskripsi_modul.text = currentItem.deskripsi_modul
        holder.container_modul.setOnClickListener {jointoactivity(currentItem)}
    ...
    private fun jointoactivity(currentItem: Model_Data) {
        ...
        intent.putExtra("judul",currentItem.judul_modul)
        intent.putExtra("link", currentItem.link_modul)
